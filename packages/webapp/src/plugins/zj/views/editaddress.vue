<template>
  <div class="addaddress">
    ...
    <van-nav-bar>
      <template #title>
        <h1 class="text-[#333] text-[20px] font-bold"> 请编辑您的发货地址 </h1>
      </template>
      <template #left>
    ...
    <van-form class="middle-form" label-width="110">
      <van-cell-group>
        ...
        <van-field v-model="houseNumber" label="门牌号" placeholder="请填写门牌号（非必填）" />
        <van-field
          v-model="userName"
          label="联系人"
          placeholder="请输入姓名"
      ...
      <!-- 是否设置地址为默认地址 -->
      <van-field name="switch" label-width="200" label="是否设置地址为默认地址">
        <template #input>
    ...
    <div class="submit-panel">
      <van-button color="red" block> 删除</van-button>
    </div>
    <div class="submit-panel">
