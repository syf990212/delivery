<template>
  <div class="discount-coupon">
    <van-nav-bar right-text="不使用优惠券" @click-left="onClickLeft" @click-right="onClickRight">
      <template #left>
        <van-icon name="question-o" color="#666" />
        <span style="color: #666666">使用说明</span>
      </template>
    </van-nav-bar>
      ...
      <div class="coupon-right">
        <div class="right-text">
          ...
          <van-dropdown-menu style="padding-left: 0">
            <div class="dis_img">
              <img src="@/assets/coupon/coupon-dis-use.png" alt="" />
            </div>
...
export default defineComponent({
  setup() {
    ...
    const onClickLeft = () => $router.push('/coupon/usemethod.vue')
